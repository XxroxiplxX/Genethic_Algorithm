...
public class Test1 {
    ...
    public void orderCrossoverTest() {
        ...
        int[] p2 = {
                9,10,11,0,15,16,3,6,7,8,4,5,12,13,14,1,2
        };
        Individual experimentObject = new Individual(17,p1);
        ...
        System.out.println();
        //System.out.println(population.getOF(experimentObject));
        for (int i = 0; i < 17; i++) {
            System.out.print(res[1].getGen(i) + " ");
        }
        System.out.println();
        experimentObject.mutationInsert(4,5);
        experimentObject.printIndividual();
